...
BetaMatrix_maxvar <- CollapseCpGsGenes(BetaMatrix, method = "maxvar")
BetaMatrix_pca <- CollapseCpGsGenes(BetaMatrix, method = "PCA")
...
xCellScores_noReverseRank <-  xCellAnalysis(aggdata_rank_noReverse, rnaseq = TRUE)
xCellScores <- xCellAnalysis(aggdata_rank, rnaseq = TRUE)
